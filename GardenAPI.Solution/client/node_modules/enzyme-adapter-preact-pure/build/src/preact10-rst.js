...
import { getChildren, getComponent, getDOMNode, getLastRenderOutput, getLastVNodeRenderedIntoContainer, } from './preact10-internals.js';
 ...
 * node.
 */
export function rstNodeFromElement(node, preserveChildrenProp = false) {
 ...
 */
export function getNode(container) {
