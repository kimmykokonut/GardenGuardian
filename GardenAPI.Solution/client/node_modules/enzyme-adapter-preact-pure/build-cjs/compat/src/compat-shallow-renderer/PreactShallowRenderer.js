...
const preact10_internals_js_1 = require("../../../src/preact10-internals.js");
const preact10_shallow_diff_js_1 = require("./preact10-shallow-diff.js");
...
function installOptionsForShallowRender() {
  ...
  options.__r = vnode => {
    prevRender(vnode);
    const component = (0, preact10_internals_js_1.getComponent)(vnode);
...
function installShallowComponentHooks() {
  const prevSetState = preact_1.Component.prototype.setState;
  preact_1.Component.prototype.setState = function (update, callback) {
    if (this._preactShallowRenderer) {
      preact10_shallow_diff_js_1.shallowSetState.call(this, update, callback);
    } else {
      prevSetState.call(this, update, callback);
    }
  };
  const prevForceUpdate = preact_1.Component.prototype.forceUpdate;
  preact_1.Component.prototype.forceUpdate = function (callback) {
    if (this._preactShallowRenderer) {
      preact10_shallow_diff_js_1.shallowForceUpdate.call(this, callback);
    } else {
...
class PreactShallowRenderer {
  ...
  render(element, context = {}) {
    ...
    try {
      ...
      (0, preact10_shallow_diff_js_1.commitRoot)(commitQueue, element);
      this._componentInstance = (0, preact10_internals_js_1.getComponent)(this._prevElement // this._diffComponent sets _prevElement for us
      );
  ...
  unmount() {
    ...
    if (this._prevElement) {
      (0, preact10_shallow_diff_js_1.unmount)(this._prevElement);
    }
    if (this._memoElement) {
      (0, preact10_shallow_diff_js_1.unmount)(this._memoElement);
    }
    PreactShallowRenderer.current = null;
    this._reset();
  }
  ...
  _diffComponent(newVNode, oldVNode, globalContext, commitQueue) {
    ...
    if (isMemo(newVNode)) {
      ...
      renderResult = (0, preact10_shallow_diff_js_1.diffComponent)(newVNode, oldVNode, globalContext, commitQueue);
      if (renderResult == preact10_shallow_diff_js_1.skipUpdateSymbol) {
    ...
    return renderResult === preact10_shallow_diff_js_1.skipUpdateSymbol ? this._rendered : renderResult;
  }
}
exports.default = PreactShallowRenderer;
...
function isComponentVNode(element) {
  return (0, preact_1.isValidElement)(element) && typeof element.type === 'function';
}
function assertIsComponentVNode(element) {
  if (!(0, preact_1.isValidElement)(element)) {
