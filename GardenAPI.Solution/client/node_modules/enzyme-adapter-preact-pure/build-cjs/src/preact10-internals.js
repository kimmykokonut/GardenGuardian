...
exports.getChildren = exports.getComponent = exports.getDOMNode = exports.getLastRenderOutput = exports.getLastVNodeRenderedIntoContainer = void 0;
/**
 * Return the last VNode that was rendered into a container using Preact's
 * `render` function.
 */
function getLastVNodeRenderedIntoContainer(container) {
    const preactContainer = container;
    return preactContainer.__k;
}
exports.getLastVNodeRenderedIntoContainer = getLastVNodeRenderedIntoContainer;
/**
 * Return the VNode returned when `component` was last rendered.
 */
function getLastRenderOutput(component) {
    const preactComponent = component;
    return getChildren(preactComponent.__v);
}
exports.getLastRenderOutput = getLastRenderOutput;
/**
